...
const ExpensesList = lazy(() => import('../feature-module/finance-accounts/expenseslist'));
const ExpenseCategory = lazy(() => import('../feature-module/finance-accounts/expensecategory'));
...
const ReorderStock = lazy(() => import('../feature-module/stock/reorder-stock'));
...
const PurchasesList = lazy(() => import('../feature-module/purchases/purchase-list'));
const PurchaseInventory = lazy(() => import('../feature-module/purchases/purchase-inventory/purchase-inventory'));
const PurchasesDamages = lazy(() => import('../feature-module/purchases/purchase-damages/purchase-damage'));
const PurchasePayables = lazy(() => import('../feature-module/purchases/purchase-payables/purchase-payables'));
const PurchaseOrderReport = lazy(() => import('../feature-module/purchases/purchase-order-report'));
const PurchaseReturns = lazy(() => import('../feature-module/purchases/purchase-returns'));
...
const StockPrice = lazy(() => import('../feature-module/stock/stock-pricing'));
const StockAdjustment = lazy(() => import('../feature-module/stock/stock-adjustment'));
const StockTransfer = lazy(() => import('../feature-module/stock/stock-transfer'));
...
const SigninThree = lazy(() => import('../feature-module/pages/authentication/login/signinThree'));
const RegisterTwo = lazy(() => import('../feature-module/pages/authentication/register/registerTwo'));
const Register = lazy(() => import('../feature-module/pages/authentication/register/register'));
const RegisterThree = lazy(() => import('../feature-module/pages/authentication/register/registerThree'));
const Forgotpassword = lazy(() => import('../feature-module/pages/authentication/forgotpassword/forgotpassword'));
const ForgotpasswordTwo = lazy(() => import('../feature-module/pages/authentication/forgotpassword/forgotpasswordTwo'));
const ForgotpasswordThree = lazy(() => import('../feature-module/pages/authentication/forgotpassword/forgotpasswordThree'));
const Resetpassword = lazy(() => import('../feature-module/pages/authentication/resetpassword/resetpassword'));
const ResetpasswordTwo = lazy(() => import('../feature-module/pages/authentication/resetpassword/resetpasswordTwo'));
const ResetpasswordThree = lazy(() => import('../feature-module/pages/authentication/resetpassword/resetpasswordThree'));
const EmailVerification = lazy(() => import('../feature-module/pages/authentication/emailverification/emailverification'));
const EmailverificationTwo = lazy(() => import('../feature-module/pages/authentication/emailverification/emailverificationTwo'));
const EmailverificationThree = lazy(() => import('../feature-module/pages/authentication/emailverification/emailverificationThree'));
const Twostepverification = lazy(() => import('../feature-module/pages/authentication/twostepverification/twostepverification'));
const TwostepverificationTwo = lazy(() => import('../feature-module/pages/authentication/twostepverification/twostepverificationTwo'));
const TwostepverificationThree = lazy(() => import('../feature-module/pages/authentication/twostepverification/twostepverificationThree'));
...
const KanbanView = lazy(() => import('../feature-module/application/kanbanView'));
const SocialFeed = lazy(() => import('../feature-module/application/socialfeed'));
const NewDashboard = lazy(() => import('../feature-module/dashboard/newDashboard'));
...
const Invoicedetails = lazy(() => import('../feature-module/sales/invoicedetails'));
const Discount = lazy(() => import('../feature-module/coupons/discount'));
const DiscountPlan = lazy(() => import('../feature-module/coupons/discountPlan'));
const GiftCards = lazy(() => import('../feature-module/coupons/giftCards'));
const Accountlist = lazy(() => import('../feature-module/finance-accounts/account-list/accountlist'));
const Moneytransfer = lazy(() => import('../feature-module/finance-accounts/money-transfer/moneytransfer'));
const Balancesheet = lazy(() => import('../feature-module/finance-accounts/balance-sheet/balancesheet'));
const Trailbalance = lazy(() => import('../feature-module/finance-accounts/trail-balance/trailbalance'));
const Cashflow = lazy(() => import('../feature-module/finance-accounts/cash-flow/cashflow'));
const CashbookLedger = lazy(() => import('../feature-module/finance-accounts/cash-book/cash-book-ledger'));
const AssetRegister = lazy(() => import('../feature-module/finance-accounts/asset-register/assetsregister'));
const Accountstatement = lazy(() => import('../feature-module/finance-accounts/account-statement/accountstatement'));
const Biller = lazy(() => import('../feature-module/people/billers'));
const Employeedetails = lazy(() => import('../feature-module/hrm/employeedetails'));
const Stockhistory = lazy(() => import('../feature-module/Reports/stockhistory'));
...
const Invoicereportnew = lazy(() => import('../feature-module/Reports/invoicereportnew'));
const Languagesetteingsweb = lazy(() => import('../feature-module/settings/websitesettings/languagesetteingsweb'));
const Success = lazy(() => import('../feature-module/pages/authentication/success/success'));
const SuccessTwo = lazy(() => import('../feature-module/pages/authentication/success/successTwo'));
const SuccessThree = lazy(() => import('../feature-module/pages/authentication/success/successThree'));
const EmployeesList = lazy(() => import('../feature-module/hrm/employeesList'));
const IncomeList = lazy(() => import('../feature-module/finance-accounts/income/incomeList'));
const IncomeCategory = lazy(() => import('../feature-module/finance-accounts/income/incomeCategory'));
const Products = lazy(() => import('../feature-module/ecommerce/products'));
const Productsdetails = lazy(() => import('../feature-module/ecommerce/productsdetails'));
...
const SuperAdminDashboard = lazy(() => import('../feature-module/super-admin/dashboard'));
...
const Packages = lazy(() => import('../feature-module/super-admin/packages/packagelist'));
const Domain = lazy(() => import('../feature-module/super-admin/domin'));
const PurchaseTransaction = lazy(() => import('../feature-module/super-admin/purchase-transaction'));
const EmailReply = lazy(() => import('../feature-module/application/emailReply'));
const Todo = lazy(() => import('../feature-module/application/todo/todo'));
const TodoList = lazy(() => import('../feature-module/application/todo/todolist'));
...
const Searchlist = lazy(() => import('../feature-module/application/searchlist'));
const SupplierDueReport = lazy(() => import('../feature-module/Reports/supplierduereport'));
const CustomerDueReport = lazy(() => import('../feature-module/Reports/customerduereport'));
const Productreport = lazy(() => import('../feature-module/Reports/products-report/productreport'));
const ProductExpiredreport = lazy(() => import('../feature-module/Reports/products-report/productexpiredreport'));
const ProductQualityreport = lazy(() => import('../feature-module/Reports/products-report/productqualityreport'));
...
const InvoiceTemplate = lazy(() => import('../feature-module/settings/appsetting/invoicetemplate'));
const Signature = lazy(() => import('../feature-module/settings/appsetting/signature'));
const Emailtemplatesettings = lazy(() => import('../feature-module/settings/systemsettings/emailtemplatesettings'));
const Smstemplate = lazy(() => import('../feature-module/settings/systemsettings/smstemplate'));
const LayoutDemo = lazy(() => import('../components/layouts/layoutdemo'));
const BlogDetails = lazy(() => import('../feature-module/content/blog/blogDetails'));
const BlogTags = lazy(() => import('../feature-module/content/blog/blogTags'));
const BlogCategories = lazy(() => import('../feature-module/content/blog/blogCategories'));
const BlogComments = lazy(() => import('../feature-module/content/blog/blogComments'));
const Cities = lazy(() => import('../feature-module/content/location/cities'));
const Countries = lazy(() => import('../feature-module/content/location/countries'));
...
export const authRoutes = [
  ...
  {
    id: 168,
    path: routes.purchaseInventory,
    name: 'purchaselist stock',
    element: <PurchaseInventory />,
    route: Route
  },
  {
    id: 268,
    path: routes.purchaseDamages,
    name: 'purchaselist damages',
    element: <PurchasesDamages />,
    route: Route
  },
  {
    id: 368,
    path: routes.purchasepayables,
    name: 'purchase payables',
    element: <PurchasePayables />,
    route: Route
  },
  {
    id: 69,
  ...
  },
  {
    ...
    name: 'cash-book',
    element: <CashbookLedger />,
    route: Route
  },
  {
    id: 11280,
    path: routes.asset_regster,
    name: 'asset register',
