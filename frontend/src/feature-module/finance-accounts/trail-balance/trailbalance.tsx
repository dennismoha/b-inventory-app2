...
import { useGetAccountsTrialBalanceQuery } from '@core/redux/api/inventory-api';
import TrialBalanceTable from './trialbalancetable';
import type { TrialBalance } from '@/feature-module/interface/features-interface';

const Trailbalance = () => {
  const { data: trialBalanceData } = useGetAccountsTrialBalanceQuery();
  const actualTrialBalance: TrialBalance | undefined = trialBalanceData?.data;
  console.log('data is ', actualTrialBalance);
      ...
      <div className="page-wrapper">
        <div className="content">
          ...
          <div className="card table-list-card bg-transparent border-0">
                ...
                <table className="table datanew">
                  ...
                  <tbody>
                    ...
                    <tr className="border-bottom">
                      <td className="p-2 border-1 fw-bold text-gray-9">Total Assets</td>
                      <td className="p-2 border-1 fw-bold text-gray-9">$37,000</td>
                      <td className="p-2 border-1" />
                    </tr>
                    <tr>
                      <td className="p-2 border-1 fw-bold text-gray-9">Liabilities</td>
                      <td className="p-2 border-1" />
                      <td className="p-2 border-1" />
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="bg-secondary-transparent text-gray-9 fw-bold p-3">$37,000</td>
                      <td className="bg-secondary-transparent text-gray-9 fw-bold p-3">$37,000</td>
                    </tr>
                  </tbody>
                </table>
            ...
            {!actualTrialBalance || !actualTrialBalance.trialBalance || actualTrialBalance.trialBalance.length === 0 ? (
              <p>no data to create a trial balance</p>
            ) : (
              <TrialBalanceTable datas={actualTrialBalance} />
            )}
          </div>
          {/* /product list */}
        </div>
