              ...
              <div className="pos-categories tabs_wrapper pb-0">
                <div className="card pos-button">
                  <div className="d-flex align-items-center flex-wrap">
                    <Link to="#" className="btn btn-teal btn-md mb-xs-3" data-bs-toggle="modal" data-bs-target="#orders">
                      <i className="ti ti-shopping-cart me-1" />
                      View Orders
                    </Link>
                    <Link to="#" className="btn btn-md btn-indigo" data-bs-toggle="modal" data-bs-target="#reset">
                      <i className="ti ti-reload me-1" />
                      Reset
                    </Link>
                    <Link to="#" className="btn btn-md btn-info" data-bs-toggle="modal" data-bs-target="#recents">
                    ...
                    <div className={`tab_content ${activeTab === 'all' ? 'active' : ''} `} data-tab="all">
                      <div className="row">
                        <div className="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                          <div className="product-info card" onClick={() => setShowAlert1(!showAlert1)}>
                        ...
                        <div className="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                          <div className="product-info card active" onClick={() => setShowAlert1(!showAlert1)}>
                            <Link to="#" className="pro-img">
              ...
              <aside className="product-order-list">
                ...
                <div className="product-added block-section">
                  <div className="head-text d-flex align-items-center justify-content-between">
                    ...
                    <Link to="#" className="d-flex align-items-center link-danger">
                      <span className="me-2">
                  ...
                  <div className="product-wrap">
                    ...
                    <div className="product-list align-items-center justify-content-between">
                      ...
                      <div className="d-flex align-items-center action">
                        <Link className="btn-icon edit-icon me-1" to="#" data-bs-toggle="modal" data-bs-target="#edit-product">
                ...
                <div className="block-section payment-method">
                  ...
                  <div className="row align-items-center justify-content-center methods g-3">
                    <div className="col-sm-6 col-md-4">
                      <Link to="#" className="payment-item" data-bs-toggle="modal" data-bs-target="#payment-cash">
                        <i className="ti ti-cash-banknote fs-18" />
                        <span>Cash</span>
                      </Link>
                    </div>
                    <div className="col-sm-6 col-md-4">
                      <Link to="#" className="payment-item" data-bs-toggle="modal" data-bs-target="#payment-card">
                        <i className="ti ti-credit-card fs-18" />
                        <span>Debit Card</span>
                      </Link>
                    </div>
                    <div className="col-sm-6 col-md-4">
                      <Link to="#" className="payment-item" data-bs-toggle="modal" data-bs-target="#scan-payment">
                ...
                <div className="btn-row d-sm-flex align-items-center justify-content-between">
                  ...
                  <Link to="#" className="btn btn-danger d-flex align-items-center justify-content-center flex-fill">
