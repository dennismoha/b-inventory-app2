                          ...
                          >
                            ...
                            <div className="product-content text-center">
                              ...
                              <div className="text-center">
                                <h6 className="fs-14 fw-bold text-gray-6">$30</h6>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-md-4 col-lg-6 col-xl-4 col-xxl-3">
                          ...
                          >
                            ...
                            <div className="product-content text-center">
                              ...
                              <div className="text-center">
                                <h6 className="fs-14 fw-bold text-gray-6">$120</h6>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-md-4 col-lg-6 col-xl-4 col-xxl-3">
                          ...
                          >
                            ...
                            <div className="product-content text-center">
                              ...
                              <div className="text-center">
                                <h6 className="fs-14 fw-bold text-gray-6">$800</h6>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-md-4 col-lg-6 col-xl-4 col-xxl-3">
                          ...
                          >
                            ...
                            <div className="product-content text-center">
                              ...
                              <div className="text-center">
                                <h6 className="fs-14 fw-bold text-gray-6">$700</h6>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-md-4 col-lg-6 col-xl-4 col-xxl-3">
                          ...
                          >
                            ...
                            <div className="product-content text-center">
                              ...
                              <div className="text-center">
                                <h6 className="fs-14 fw-bold text-gray-6">$600</h6>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-md-4 col-lg-6 col-xl-4 col-xxl-3">
                          ...
                          >
                            ...
                            <div className="product-content text-center">
                              ...
                              <div className="text-center">
                                <h6 className="fs-14 fw-bold text-gray-6">$300</h6>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="col-sm-6 col-md-4 col-lg-6 col-xl-4 col-xxl-3">
                          ...
                          >
                            ...
                            <div className="product-content text-center">
                              ...
                              <div className="text-center">
                                <h6 className="fs-14 fw-bold text-gray-6">$1430</h6>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-md-4 col-lg-6 col-xl-4 col-xxl-3">
                          ...
                          >
                            ...
                            <div className="product-content text-center">
                              ...
                              <div className="text-center">
                                <h6 className="fs-14 fw-bold text-gray-6">$1560</h6>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-md-4 col-lg-6 col-xl-4 col-xxl-3">
                          ...
                          >
                            ...
                            <div className="product-content text-center">
                              ...
                              <div className="text-center">
                                <h6 className="fs-14 fw-bold text-gray-6">$410</h6>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-md-4 col-lg-6 col-xl-4 col-xxl-3">
                          ...
                          >
                            ...
                            <div className="product-content text-center">
                              ...
                              <div className="text-center">
                                <h6 className="fs-14 fw-bold text-gray-6">$150</h6>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-md-4 col-lg-6 col-xl-4 col-xxl-3">
                          ...
                          >
                            ...
                            <div className="product-content text-center">
                              ...
                              <div className="text-center">
                                <h6 className="fs-14 fw-bold text-gray-6">$1140</h6>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-md-4 col-lg-6 col-xl-4 col-xxl-3">
                          ...
                          >
                            ...
                            <div className="product-content text-center">
                              ...
                              <div className="text-center">
                                <h6 className="fs-14 fw-bold text-gray-6">$15</h6>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-md-4 col-lg-6 col-xl-4 col-xxl-3">
                          ...
                          >
                            ...
                            <div className="product-content text-center">
                              ...
                              <div className="text-center">
                                <h6 className="fs-14 fw-bold text-gray-6">$320</h6>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-md-4 col-lg-6 col-xl-4 col-xxl-3">
                          ...
                          >
                            ...
                            <div className="product-content text-center">
                              ...
                              <div className="text-center">
                                <h6 className="fs-14 fw-bold text-gray-6">$230</h6>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-md-4 col-lg-6 col-xl-4 col-xxl-3">
                          ...
                          >
                            ...
                            <div className="product-content text-center">
                              ...
                              <div className="text-center">
                                <h6 className="fs-14 fw-bold text-gray-6">$160</h6>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-md-4 col-lg-6 col-xl-4 col-xxl-3">
                          ...
                          >
                            ...
                            <div className="product-content text-center">
                              ...
                              <div className="text-center">
                                <h6 className="fs-14 fw-bold text-gray-6">$1200</h6>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-md-4 col-lg-6 col-xl-4 col-xxl-3">
                          ...
                          >
                            ...
                            <div className="product-content text-center">
                              ...
                              <div className="text-center">
                                <h6 className="fs-14 fw-bold text-gray-6">$900</h6>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-md-4 col-lg-6 col-xl-4 col-xxl-3">
                          ...
                          >
                            ...
                            <div className="product-content text-center">
                              ...
                              <div className="text-center">
                                <h6 className="fs-14 fw-bold text-gray-6">$80</h6>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-md-4 col-lg-6 col-xl-4 col-xxl-3">
                          ...
                          >
                            ...
                            <div className="product-content text-center">
                              ...
                              <div className="text-center">
                                <h6 className="fs-14 fw-bold text-gray-6">$170</h6>
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              <aside className="product-order-list">
                <div className="customer-info">
                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-md-4">
                      <input type="text" className="form-control" placeholder="Type Ref Number" />
                    </div>
                    <div className="col-md-4">
                      <CommonSelect
                    ...
                    <div className="col-md-6">
                      <input type="text" className="form-control" placeholder="Currency Exchange Rate" />
                    </div>
                  </div>
                </div>
                        ...
                        <table className="table table-borderless">
                          <thead>
                            <tr>
                              ...
                              <th className="bg-transparent fw-bold">Batch No</th>
                              <th className="bg-transparent fw-bold">Price</th>
                              <th className="bg-transparent fw-bold">QTY</th>
                              <th className="bg-transparent fw-bold">Sub Total</th>
