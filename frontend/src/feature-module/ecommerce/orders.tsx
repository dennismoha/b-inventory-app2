...

    {
      ...
      body: () => (
        <div className="edit-delete-action d-flex align-items-center">
          <Link className="me-2 edit-icon p-2 border d-flex align-items-center rounded" to={route.invoicedetails}>
            <i className="feather icon-eye action-eye" />
          </Link>
          <Link className="me-2 p-2 d-flex align-items-center border rounded" to={route.editproduct}>
            <i className="feather icon-edit feather-edit" />
          </Link>
          <Link className="p-2 d-flex align-items-center border rounded" to="#;" data-bs-toggle="modal" data-bs-target="#delete">
                        ...
                        <div className="row">
                          <div className="col-lg-12">
                            <div className="modal-footer-btn">
                              <button type="button" className="btn btn-cancel me-2 p-2 px-3" data-bs-dismiss="modal">
                                Cancel
                              </button>
                              <Link to="submit" className="btn btn-submit p-2 px-3" data-bs-dismiss="modal">
                                Submit
                              </Link>
                            </div>
                          </div>
