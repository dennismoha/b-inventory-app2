  ...
  const columns = [
    {
      title: 'ID',
      dataIndex: 'ID',
      render: (text: any) => <Link to={all_routes.employeedetails}>{text}</Link>,
...

    {
      ...
      render: () => (
        <div className="edit-delete-action d-flex align-items-center">
          <Link className="me-2 d-flex align-items-center border rounded p-2" to={all_routes.employeedetails}>
            <i data-feather="eye" className="feather-eye" />
          </Link>
          <Link className="me-2 p-2 d-flex align-items-center border rounded" to={all_routes.editemployee}>
            <i data-feather="edit" className="feather-edit" />
          </Link>
          <Link data-bs-toggle="modal" data-bs-target="#delete-modal" className="p-2 d-flex align-items-center border rounded" to="#">
            ...
            <div className="page-wrapper-new p-0">
              <div className="content p-5 px-3 text-center">
                ...
                <div className="modal-footer-btn mt-3 d-flex justify-content-center">
                  ...
                  <button type="button" data-bs-dismiss="modal" className="btn btn-submit fs-13 fw-medium p-2 px-3">
                    Yes Delete
                  </button>
                </div>
              </div>
