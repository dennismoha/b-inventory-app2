          ...
          <div className="row">
            ...
            <div className="col-xl-4">
              <div className="card">
                ...
                <div className="card-body">
                  <button type="button" className="btn btn-primary btn-wave" id="liveToastBtn" onClick={handleLiveToastButtonClick}>
                    Show live toast
                  </button>
            ...
            <div className="col-xl-4">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="toast align-items-center fade show mb-3" role="alert" aria-live="assertive" aria-atomic="true">
                    <div className="d-flex">
                      <div className="toast-body">Hello, world! This is a toast message.</div>
                  ...
                  <div>
                    <span className="my-4 text-muted">Alternatively, you can also add additional controls and components to toasts.</span>
                  </div>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="btn-list">
                    ...
                    <button type="button" className="btn btn-info me-2 btn-wave" id="infoToastBtn" onClick={handleInfoToastButtonClick}>
                      Info
                    </button>
                    <button
                      type="button"
          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="card">
                ...
                <div className="card-body">
                  <div className="btn-list">
                    <Button variant="outline-primary me-2 btn-wave" id="topleftToastBtn" onClick={handleTopLeftButtonClick}>
                      Top Left
                    </Button>
                    <button
                      type="button"
