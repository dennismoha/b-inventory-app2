        ...
        <div className="row">
                        ...
                        <div className="d-flex align-items-start">
                          ...
                          <div className="text-primary w-100">
                            <div className="fw-semibold d-flex justify-content-between">
                              Information Alert
                              <button type="button" className="btn-close p-0" data-bs-dismiss="alert" aria-label="Close">
                                <i className="fas fa-xmark" />
                              </button>
                            </div>
          ...
          <div className="col-xl-6">
            <div className="card">
              ...
              <div className="card-body">
                <div className="alert alert-img alert-primary alert-dismissible fase show rounded-pill flex-wrap" role="alert">
                ...
                <div className="alert alert-img alert-secondary alert-dismissible fase show rounded-pill flex-wrap" role="alert">
                  <div className="avatar avatar-sm me-3 avatar-rounded">
                ...
                <div className="alert alert-img alert-warning alert-dismissible fase show rounded-pill flex-wrap" role="alert">
                  <div className="avatar avatar-sm me-3 avatar-rounded">
                ...
                <div className="alert alert-img alert-danger alert-dismissible fase show rounded-pill flex-wrap" role="alert">
                  <div className="avatar avatar-sm me-3 avatar-rounded">
                ...
                <div className="alert alert-img alert-info alert-dismissible fase show rounded-pill flex-wrap" role="alert">
                  <div className="avatar avatar-sm me-3 avatar-rounded">
                ...
                <div className="alert alert-img alert-light alert-dismissible fase show rounded-pill flex-wrap" role="alert">
                  <div className="avatar avatar-sm me-3 avatar-rounded">
                ...
                <div className="alert alert-img alert-dark alert-dismissible fase show rounded-pill flex-wrap" role="alert">
                  <div className="avatar avatar-sm me-3 avatar-rounded">
                    <img src={avatar_07} alt="img" />
                  </div>
                  ...
                  <div className="col-xl-6">
                    <div className="alert alert-primary overflow-hidden p-0" role="alert">
                      <div className="p-3 bg-primary text-fixed-white d-flex justify-content-between">
                        ...
                        <button type="button" className="btn-close p-0 text-fixed-white" data-bs-dismiss="alert" aria-label="Close">
                          <i className="fas fa-xmark" />
                        </button>
                      </div>
                      <hr className="my-0" />
