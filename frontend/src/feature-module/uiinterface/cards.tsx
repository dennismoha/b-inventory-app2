          ...
          <div className="row">
            ...
            <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration many
                    variations of passages of Lorem Ipsum available there are so many ways to solve but the majority have suffered.
                  </p>
                </div>
                <div className="card-footer">
            ...
            <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
              <div className="card">
                ...
                <div className="card-body">
                  <p className="card-text">
                    &apos; can be escaped with &apos;&rsquo;&apos; Some quick example text to build on the card title and make up the bulk
            ...
            <div className="col-xxl-6 col-xl-6 col-lg-12">
              ...
              <div className="row row-cols-12">
                <div className="col">
                  <div className="card">
                    <div className="card-body">
                      <img src={img_04} className="card-img mb-3" alt="..." />
                ...
                <div className="col">
                  <div className="card">
                    <div className="card-body">
                      <img src={img_05} className="card-img mb-3" alt="..." />
                ...
                <div className="col">
                  <div className="card">
                    <div className="card-body">
                      <img src={img_02} className="card-img mb-3" alt="..." />
          ...
          <div className="row">
              ...
              <div className="card">
                <div className="card-header">
                  <div className="d-flex align-items-center w-100">
                    <img src={avator1} alt="img" className="avatar avatar-rounded me-2" />
                    <div className="">
                ...
                <div className="card-body">
                  If you are going to use, you need to be sure there isn&apos;t anything embarrassing hidden in the middle of text. All the
            ...
            <div className="col-xl-3">
              <div className="card border border-primary">
                ...
                <div className="card-footer">Lorem Ipsum is therefore always free from repetition, injected humour.</div>
              </div>
            </div>
            <div className="col-xl-2">
              <div className="card">
                <div className="card-body">
                  <img src={img1} className="card-img mb-3" alt="..." />
            ...
            <div className="col-xl-2">
              <div className="card">
                <div className="card-body">
                  <img src={img2} className="card-img mb-3" alt="..." />
                  <h6 className="card-title fw-semibold mb-3">
                    Hills
            ...
            <div className="col-xl-2">
              <div className="card">
                <div className="card-body">
                  <img src={img3} className="card-img mb-3" alt="..." />
                  <h6 className="card-title fw-semibold mb-3">
                    Nature
          ...
          <div className="row">
            ...
            <div className="col-xl-4">
              <div className="card">
                ...
                <img src={img_02} className="card-img-bottom" alt="..." />
              </div>
            </div>
            <div className="col-xl-4">
              <div className="card">
                ...
                <img src={img2} className="card-img rounded-0" alt="..." />
                <div className="card-body">
                  <p className="card-text mb-0">
                    <small>Last updated 3 mins ago</small>
                  </p>
            ...
            <div className="col-xl-4">
              <div className="card">
                ...
                <img src={img_04} className="card-img rounded-0" alt="..." />
                <div className="card-footer">
                  <p className="card-text mb-0">
                    <small>Last updated 3 mins ago</small>
                  </p>
              ...
              <div className="card">
                <div className="row g-0">
                  <div className="col-md-4">
                    <img src={img_05} className="img-fluid rounded-start object-fit-cover h-100 w-100" alt="..." />
                  </div>
            ...
            <div className="col-xl-4">
              <div className="card">
                <div className="row g-0">
                  <div className="col-md-8">
                    ...
                    <div className="card-body">
                      ...
                      <p className="card-text mb-3">
                        This is a wider card with suppo rting text below as a natural lead-in to additional content. This content is a
                        little bit longer.
                      </p>
                      <p className="card-text">
                        <small className="text-muted">Last updated 3 mins ago</small>
                  ...
                  <div className="col-md-4">
                    <img src={img_01} className="img-fluid rounded-end object-fit-cover h-100 w-100" alt="..." />
                  </div>
                </div>
              </div>
            </div>
            <div className="col-xl-4">
              <div className="card">
                <div className="row g-0">
                  ...
                  <div className="col-md-4">
                    <img src={img_02} className="img-fluid rounded-end object-fit-cover h-100 w-100" alt="..." />
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div className="row g-0">
                      <div className="col-md-8">
                        <div className="card-body">
                          ...
                          <p className="card-text mb-0">
                            This is a wild animal with supporting tactics and are very efficient at kill,they are very Dangerous.
                          </p>
                          <p className="mb-0 card-text">Fox lives mainly in forests and are well known for their hunting skills.</p>
                        </div>
                        <div className="card-footer">
                          <p className="card-text">
                            <small className="text-muted">Last updated 3 mins ago</small>
                      ...
                      <div className="col-md-4">
                        <img src={img5} className="img-fluid rounded-end object-fit-cover h-100" alt="..." />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="row row-cols-1 row-cols-md-4 g-4">
                ...
                <div className="col">
                  <div className="card">
                    <img src={img_04} className="card-img-top" alt="..." />
                    <div className="card-body">
