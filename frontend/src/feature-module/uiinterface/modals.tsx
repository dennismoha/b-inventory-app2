        ...
        <div className="row">
            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <div className="button-list">
                  {/* Standard  modal */}
                  <button type="button" className="btn btn-primary mt-1 me-1" data-bs-toggle="modal" data-bs-target="#standard-modal">
                    Launch Demo Modal
                  </button>
                </div>
              </div>
          ...
          <div className="col-xl-4">
            <div className="card">
              ...
              <div className="card-body card-buttons">
                <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#scrollable-modal">
                  Scrolling Long Content
                </button>
        ...
        <div className="row">
          ...
          <div className="col-xl-4">
            <div className="card">
              ...
              <div className="card-body">
                <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalScrollable5">
                  Launch demo modal
                </button>
                <div
                  className="modal fade"
          ...
          <div className="col-xl-4">
            <div className="card">
              ...
              <div className="card-body">
                ...
                {/* /Modal */}
                {/* Modal */}
                <div className="modal fade" id="exampleModalLg" tabIndex={-1} aria-labelledby="exampleModalLgLabel" aria-hidden="true">
                  <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                      <div className="modal-header">
                ...
                {/* /Modal */}
                <div className="button-list">
                  <button type="button" className="btn btn-primary mt-1 me-1" data-bs-toggle="modal" data-bs-target="#exampleModalLg">
                    Extra Large Modal
                  </button>
                  <button type="button" className="btn btn-primary mt-1 me-1" data-bs-toggle="modal" data-bs-target="#bs-example-modal-lg">
                    Large Modal
                  </button>
                  <button type="button" className="btn btn-primary mt-1 me-1" data-bs-toggle="modal" data-bs-target="#bs-example-modal-sm">
                    Small Modal
                  </button>
                </div>
              </div>
          ...
          <div className="col-xl-6">
            <div className="card">
              ...
              <div className="card-body card-buttons">
                          ...
                          <div className="auth-logo">
                            <Link to={route.dashboard} className="logo logo-dark">
                              <span className="logo-lg">
                                <img src="src/assets/img/logo.png" alt="Logo" height={42} />
                              </span>
                            </Link>
                          </div>
                        </div>
                ...
                <div className="button-list">
                  {/* Sign Up modal */}
                  <button type="button" className="btn btn-primary mt-1 me-1" data-bs-toggle="modal" data-bs-target="#signup-modal">
                    Sign Up Modal
                  </button>
                  {/* Log In modal */}
                  <button type="button" className="btn btn-primary mt-1 me-1" data-bs-toggle="modal" data-bs-target="#login-modal">
                    Log In Modal
                  </button>
                </div>
              </div>
          ...
          <div className="col-xl-6">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <div id="con-close-modal" className="modal fade" tabIndex={-1} role="dialog" aria-hidden="true" style={{ display: 'none' }}>
                  <div className="modal-dialog">
                    <div className="modal-content">
                      <div className="modal-header">
                ...
                {/* /Modal */}
                <div id="accordion-modal" className="modal fade" tabIndex={-1} role="dialog" aria-hidden="true" style={{ display: 'none' }}>
                  <div className="modal-dialog">
        ...
        <div className="row">
          ...
          <div className="col-xl-4">
            <div className="card">
              ...
              <div className="card-body">
                <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalScrollable2">
                  Vertically centered modal
                </button>
                <div
                  className="modal fade"
                ...
                >
                  ...
                  <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                      ...
                      <div className="modal-body">
                        <p>
                          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Libero ipsum quasi, error quibusdam debitis maiores hic
                          eum? Vitae nisi ipsa maiores fugiat deleniti quis reiciendis veritatis.
                        </p>
                      </div>
                      <div className="modal-footer">
                        <button type="button" className="btn btn-cancel" data-bs-dismiss="modal">
          ...
          <div className="col-xl-4">
            <div className="card">
              ...
              <div className="card-body">
                <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalScrollable3">
                ...
                >
                  ...
                  <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div className="modal-content">
                      ...
                      <div className="modal-body">
                        <p>
                          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ea voluptatibus, ipsam quo est rerum modi quos expedita
                          facere, ex tempore fuga similique ipsa blanditiis et accusamus temporibus commodi voluptas! Nobis veniam illo
                          architecto expedita quam ratione quaerat omnis. In, recusandae eos! Pariatur, deleniti quis ad nemo ipsam officia
                          temporibus, doloribus fuga asperiores ratione distinctio velit alias hic modi praesentium aperiam officiis eaque,
                          accusamus aut. Accusantium assumenda, commodi nulla provident asperiores fugit inventore iste amet aut placeat
                          consequatur reprehenderit. Ratione tenetur eligendi, quis aperiam dolores magni iusto distinctio voluptatibus
                          minus a unde at! Consequatur voluptatum in eaque obcaecati, impedit accusantium ea soluta, excepturi, quasi quia
                          commodi blanditiis? Qui blanditiis iusto corrupti necessitatibus dolorem fugiat consequuntur quod quo veniam?
                          Labore dignissimos reiciendis accusamus recusandae est consequuntur iure.
                        </p>
          ...
          <div className="col-xl-4">
            <div className="card">
              ...
              <div className="card-body">
                <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalScrollable4">
                  Launch demo modal
                </button>
                <div
                  className="modal fade"
          ...
          <div className="col-xl-6">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <div className="button-list">
                  {/* Top modal */}
                  <button type="button" className="btn btn-primary mt-1 me-1" data-bs-toggle="modal" data-bs-target="#top-modal">
                    Top Modal
                  </button>
                  {/* Bottom modal */}
                  <button type="button" className="btn btn-primary mt-1 me-1" data-bs-toggle="modal" data-bs-target="#bottom-modal">
                    Bottom Modal
                  </button>
                  {/* Center modal */}
                  <button type="button" className="btn btn-primary mt-1 me-1" data-bs-toggle="modal" data-bs-target="#centermodal">
                    Center modal
                  </button>
                  {/* Right modal */}
                  <button type="button" className="btn btn-primary mt-1 me-1" data-bs-toggle="modal" data-bs-target="#right-modal">
                    Rightbar Modal
                  </button>
                </div>
              </div>
          ...
          <div className="col-xl-6">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <div className="button-list">
                  {/* Success Alert modal */}
                  <button type="button" className="btn btn-success mt-1 me-1" data-bs-toggle="modal" data-bs-target="#success-alert-modal">
                    Success Alert
                  </button>
                  {/* Info Alert modal */}
                  <button type="button" className="btn btn-info mt-1 me-1" data-bs-toggle="modal" data-bs-target="#info-alert-modal">
                    Info Alert
                  </button>
                  {/* Warning Alert modal */}
                  <button type="button" className="btn btn-warning mt-1 me-1" data-bs-toggle="modal" data-bs-target="#warning-alert-modal">
                    Warning Alert
                  </button>
                  {/* Danger Alert modal */}
                  <button type="button" className="btn btn-danger mt-1 me-1" data-bs-toggle="modal" data-bs-target="#danger-alert-modal">
                    Danger Alert
                  </button>
                </div>
              </div>
