...
const Warranty: React.FC = () => {
  ...
  const dataSource: WarrantyData[] = useSelector((state: RootState) => state.rootReducer.warranty_data);
                ...
                <div className="modal-body">
                  <form>
                    <div className="mb-3">
                      ...
                      <input type="text" className="form-control" defaultValue="Replacement Warranty" />
                    </div>
                    <div className="row">
                      <div className="col-lg-6">
                        <div className="mb-3">
