    ...
    { header: 'Qty', field: 'qty', key: 'qty' },
    {
      ...
      body: (_row: any) => (
        <div className="d-flex align-items-center edit-delete-action">
          <Link className="me-2 border rounded d-flex align-items-center p-2" to="#" data-bs-toggle="modal" data-bs-target="#view-notes">
          ...
          <Link data-bs-toggle="modal" data-bs-target="#delete-modal" className="p-2 border rounded d-flex align-items-center" to="#">
        ...
        <div className="content">
          <div className="page-header">
            ...
            <div className="page-btn">
              <Link to="#" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-stock-adjustment">
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    <div className="mb-3">
                      ...
                      <input type="text" className="form-control" defaultValue="PT003" />
                    </div>
                  </div>
                  <div className="col-lg-12">
      ...
      <div className="modal fade" id="view-notes">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <p>
                The Jordan brand is owned by Nike (owned by the Knight family), as, at the time, the company was building its strategy to
                work with athletes to launch shows that could inspire consumers.Although Jordan preferred Converse and Adidas, they simply
                could not match the offer Nike made. Jordan also signed with Nike because he loved the way they wanted to market him with
                the banned colored shoes. Nike promised to cover the fine Jordan would receive from the NBA.
              </p>
            </div>
          </div>
        </div>
