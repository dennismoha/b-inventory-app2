            ...
            <div className="modal-content">
              ...
              <form>
                ...
                <div className="modal-footer">
                  <button type="button" className="btn btn-secondary add-cancel me-3" data-bs-dismiss="modal">
                    Cancel
                  </button>
                    ...
                    >
                      <div className="row sales-details-items d-flex">
                        ...
                        <div className="col-md-4 details-item">
                          <h6>Invoice Info</h6>
                          <p className="mb-0">
                            Reference: <span className="fs-16 text-primary ms-2">#SL0101</span>
                          </p>
                          <p className="mb-0">
                            Reference: <span className="ms-2 text-gray-9">Dec 24, 2024</span>
                          </p>
                          <p className="mb-0">
                            Status: <span className="badge badge-success ms-2">Completed</span>
                          </p>
                          <p className="mb-0">
                            Payment Status:{' '}
                              ...
                              <tr>
                                ...
                                <td>
                                  <div className="product-quantity bg-gray-transparent border-0">
                                    ...
                                    <input type="text" className="quntity-input form-control bg-transparent" defaultValue={2} />
                            ...
                            <tr>
                              ...
                              <td>
                                <div className="edit-delete-action d-flex align-items-center">
                                  <Link className="me-3 p-2 border rounded d-flex align-items-center" to="#">
                                  ...
                                  <Link className="p-2 border rounded d-flex align-items-center" to="#">
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-6 col-sm-12 col-12">
                      <div className="mb-3">
                        ...
                        <input type="text" className="form-control" defaultValue="INV/SL0101" />
                      </div>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-lg-4 col-sm-12 col-12">
                      <div className="mb-3">
                        ...
                        <div className="input-groupicon calender-input">
                          <i className="feather icon-dollar-sign info-img" />
                          <input type="text" className="form-control" defaultValue={1500} />
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-4 col-sm-12 col-12">
